    ...
    <div className="relative min-h-screen w-full overflow-hidden text-slate-800 dark:text-slate-200">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mb-14 text-center lg:py-6">
          ...
          <h1 className="mt-5 text-balance text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-3xl lg:text-4xl leading-tight">
            Đồng Tâm - Hợp lực - Toả sáng, <br className="hidden lg:inline" />
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="text-left">
              ...
              <p className="mt-0.5 text-slate-500 dark:text-slate-400">
                Trụ sở: Ấp Tân Thuận, Xã Kim Sơn, Huyện Châu Thành, Tỉnh Đồng Tháp | MST: 1200648505
              </p>
            </div>
